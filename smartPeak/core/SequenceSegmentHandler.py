...
class SequenceSegmentHandler():
    ...
    def __init__(self):
        ...
        self.optimized_components_to_concentrations = None
    ...
    def setOptimizedComponentsToConcentrations(
        self,
        optimized_components_to_concentrations_I
    ):
        """Set the optimized_components_to_concentrations"""
        self.optimized_components_to_concentrations = \
            optimized_components_to_concentrations_I
        
    def getOptimizedComponentsToConcentrations(self):
        """Return the optimized_components_to_concentrations"""
        return self.optimized_components_to_concentrations
